 ...
 * Persistent.
 *
 * We made a clone of the persistent class as it was in Moodle 3.1, and modified it
 * according to our needs. For instance, we dropped the 'usermodified' field requirement
 * to simplify the implementation of the privacy API.
 *
 * @package    block_stash
 * @copyright  2016 Frédéric Massart - FMCorz.net
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
